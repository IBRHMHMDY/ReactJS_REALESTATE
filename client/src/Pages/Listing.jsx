        ...
        {listing && !loading && !error && (
            <>
                    ...
                    {listing.imageUrls.map((url)=> (
                        <SwiperSlide key={url}>
                            <div className="h-[550px] " style={{background: `url(${url}) center no-repeat`, backgroundSize: 'cover'}}>
                                <span className='absolute top-8 right-8 rounded-full bg-slate-600 cursor-pointer text-4xl p-4'>
                ...
                <div className="flex flex-col max-w-2xl mx-auto my-10 gap-3 p-3">
                    ...
                    <Link to="" className="bg-slate-700 text-white text-center font-semibold my-3 p-3 rounded-lg w-full hover:opacity-95 disabled:opacity-80">Contact LandLord</Link>
                </div>
            </>
        )}
    </main>
